...
impl SudokuGridConflictChecker {
  pub fn new() -> SudokuGridConflictChecker {
    let cell_checkers = unsafe {
      ...
      let mut cell_checkers: [[SudokuGroupConflictChecker; 9]; 9] = mem::uninitialized();
  ...
  fn can_accomodate_choice(&self, choice: SudokuChoice) -> bool {
    ...
    if !self.cell_checkers[choice_row_idx][choice_col_idx].can_store_here(choice.value) {
      return false;
    }
    ...
    for new_row_idx in 0..9 {
      ...
      let chell_checker = &self.cell_checkers[new_row_idx][choice_col_idx];
    ...
    for new_col_idx in 0..9 {
      ...
      let chell_checker = &self.cell_checkers[choice_row_idx][new_col_idx];
      if !chell_checker.can_restrict_here(choice.value) {
        return false;
      }
    }
    ...
    SudokuBox::for_position(choice.position).positions().all(|box_pos| {
      ...
      if box_pos_row_idx == choice_row_idx {
        ...
        self.cell_checkers[box_pos_row_idx][box_pos_col_idx].can_restrict_here(choice.value)
      }
    })
  }
  ...
  fn propagate_conflicts(&mut self, choice: SudokuChoice) {
    ...
    for new_row_idx in 0..9 {
      ...
      self.cell_checkers[new_row_idx][choice_col_idx].add_conflict(choice.value);
    }
    ...
    for new_col_idx in 0..9 {
      ...
      self.cell_checkers[choice_row_idx][new_col_idx].add_conflict(choice.value);
    }
    ...
    SudokuBox::for_position(choice.position).positions().for_each(|box_pos| {
      ...
      if box_pos_row_idx == choice_row_idx {
        ...
        self.cell_checkers[box_pos_row_idx][box_pos_col_idx].add_conflict(choice.value);
      }
    });
  }
  ...
  fn unpropagate_conflicts(&mut self, choice: SudokuChoice) {
    ...
    for new_row_idx in 0..9 {
      ...
      self.cell_checkers[new_row_idx][choice_col_idx].remove_conflict(choice.value);
    }
    ...
    for new_col_idx in 0..9 {
      ...
      self.cell_checkers[choice_row_idx][new_col_idx].remove_conflict(choice.value);
    }
    ...
    SudokuBox::for_position(choice.position).positions().for_each(|box_pos| {
      ...
      if box_pos_row_idx == choice_row_idx {
        ...
        self.cell_checkers[box_pos_row_idx][box_pos_col_idx].remove_conflict(choice.value);
      }
    });
  }
}
